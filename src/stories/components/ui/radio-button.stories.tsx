 ...
 *
 * This is NOT the segmented picker in radio-group.stories.tsx. The kit ships
...
const labelClass = [
  ...
  "has-[[data-slot=radio-button]:disabled]:text-(--label-tertiary)",
  "font-sans",
...
const meta = {
  ...
  decorators: [
    (Story) => (
      <RadioButtonGroup defaultValue="selected">
        <Story />
      </RadioButtonGroup>
    ),
  ],
...
export const Selected: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(radio).toBeChecked()
    await expect(
      radio.querySelector("[data-slot=radio-button-dot]")
    ).toBeVisible()
  },
}
...
export const UnselectedHasNoDot: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(radio.querySelector("[data-slot=radio-button-dot]")).toBeNull()
  },
}
...
export const Group: Story = {
  ...
  render: () => (
    <RadioButtonGroup defaultValue="small" className="gap-2">
      <label className={labelClass}>
      ...
      <label className={labelClass}>
        <RadioButton value="huge" disabled />
...
export const AllStates: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-2">
      <RadioButtonGroup defaultValue="on" className="gap-2">
        <label className={labelClass}>
      ...
      <RadioButtonGroup defaultValue="on" className="gap-2">
        <label className={labelClass}>
          <RadioButton value="on" disabled />
          Disabled, selected
        </label>

        <label className={labelClass}>
          <RadioButton value="off" disabled />
          Disabled
        </label>
      </RadioButtonGroup>
    </div>
